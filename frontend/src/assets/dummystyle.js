export const landingPageStyles = {
  ...
  // Hero illustration
  heroIllustration: "relative w-full max-w-sm sm:max-w-md mx-auto",
...
export const authStyles = {
  ...
  signupSwitchButton: "font-black text-rose-600 hover:text-pink-600 transition-colors cursor-pointer"
};
