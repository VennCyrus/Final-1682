              ...
              <div className={landingPageStyles.statsContainer}>
                {[
                  ...
                  <div key={index} className={landingPageStyles.statItem}>
                    <div
                      className={`${landingPageStyles.statNumber} ${star.gradient}`}
                    >
                      {star.value}
                    </div>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            ...
            <a href="https://github.com/VennCyrus" target="_blank" className={landingPageStyles.footerLink}>VennCyrus</a>
          </p>
        </div>
      </footer>
